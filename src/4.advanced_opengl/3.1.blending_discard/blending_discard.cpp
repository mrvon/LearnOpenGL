...
int main() {
    ...
    GLuint transparentTexture = loadTextureAlpha("resources/textures/grass.png");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // default active texture unit. (a single sampler used in fragment is
        // set to 0 as well by default)
