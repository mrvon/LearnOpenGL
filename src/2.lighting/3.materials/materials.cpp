...
int main() {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setVec3("light.ambient", glm::vec3(ambientColor.x, ambientColor.y, ambientColor.z));
        lightingShader.setVec3("light.diffuse", glm::vec3(diffuseColor.x, diffuseColor.y, diffuseColor.z));
