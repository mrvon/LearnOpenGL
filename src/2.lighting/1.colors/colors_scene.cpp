...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // material properties
        lightingShader.setVec3("material.ambient", glm::vec3(1.0, 0.5f, 0.31f));
        lightingShader.setVec3("material.diffuse", glm::vec3(1.0, 0.5f, 0.31f));
        ...
        // lightpos.x = 3.0 * sin(glfwGetTime());
        // lightpos.z = 3.0 * cos(glfwGetTime());
        model = glm::mat4();
