...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        lightingShader.setVec3("lightPos", glm::vec3(lightPos.x, lightPos.y, lightPos.z));
        lightingShader.setVec3("viewPos", glm::vec3(camera.Position.x, camera.Position.y, camera.Position.z));
